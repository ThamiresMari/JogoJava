...
Um personagem pode ser de dois tipos: Herói ou Vilão. Independente disso, ambos possuem as seguintes características:  ? Nome; ? 
Experiência de combate (contados em anos); ? Poder, que possui uma descrição e um valor que determina sua potência. Por exemplo: “Vôo | 30”; “Rajadas de energia: 50”; “Visão telescópica: 20”. ? Armas, que também possuem uma descrição, um valor que determina seu poder de fogo e a quantidade de vezes que pode ser usada. 
